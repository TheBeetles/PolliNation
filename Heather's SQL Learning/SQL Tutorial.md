...
- compound primary key/composite key: a key that needs two attributes
...
### you can also sort returned items by information in a different, non-returned column, such as sorting by student_id:
```SQL
