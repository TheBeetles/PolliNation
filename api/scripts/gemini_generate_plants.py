...
# Run the async tasks for plants
async def main():
    await process_labelmap(
        labelmap_file=plant_labelmap_file,
        output_file=plants_output_file
    )
